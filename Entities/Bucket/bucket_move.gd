...
var bucket: Node2D
var bucket_scene: PackedScene = preload("res://Entities/Bucket/bucket.tscn")
var tween: Tween
var direction := 1
...
func reset_bucket():
	if not bucket:
		bucket_scene = preload("res://Entities/Bucket/bucket.tscn")
		bucket = bucket_scene.instantiate()
